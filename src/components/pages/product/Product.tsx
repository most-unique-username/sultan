...
const products: IProduct[] = productsBase.goods;
...
export const Product = () => {
  ...
  const product: IProduct = products.filter(item => item.vendorCode === Number(params.code))[0];
        ...
        <Container containerClass='page-product__row'>
          ...
          <Container containerClass='page-product__product-data'>
            ...
            <Container containerClass='page-product__add-box'>
              ...
              <p className='page-product__price'>{`${product.price}р`}</p>
            ...
            <Container containerClass='page-product__property-box page-product__property-box_description'>
              ...
              <p className='page-product__property-box__property'>{product.description}</p>
            </Container>
