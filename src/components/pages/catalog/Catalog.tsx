    ...
    <div className='page-catalog'>
      ...
      <Container containerClass='page-catalog__container container'>
        ...
        <Container containerClass='page-catalog__row'>
          ...
          <Container containerClass='page-catalog__filters'>

            <p className='page-catalog__filters__title'>ПОДБОР ПО ПАРАМЕТРАМ</p>

            <Container containerClass='page-catalog__price-filter-box'>
              <Container containerClass="page-catalog__box-row">
            ...
            <Container containerClass='page-catalog__filter-box'>
